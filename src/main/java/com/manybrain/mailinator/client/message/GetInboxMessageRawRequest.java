...
public class GetInboxMessageRawRequest
        implements Request<String>
{

    private static final String URL = BASE_URL + "/domains/{domain}/inboxes/{inbox}/messages/{message_id}/raw";
    ...
    public String execute(String apiToken)
    {
